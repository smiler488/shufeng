  ...
  return <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pb-16">
      ...
      <div className="px-4 py-6 space-y-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
          ...
          <div className="space-y-4 mb-6">
            ...
            <div className="bg-gradient-to-r from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 rounded-xl p-6 border border-orange-200 dark:border-orange-800">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-sm font-medium text-orange-600 dark:text-orange-400 mb-2">平方米</div>
                  <div className="text-3xl font-bold text-orange-700 dark:text-orange-300">
                    {areaResult && areaResult.m2 ? areaResult.m2.toFixed(2) : '0.00'}
                  </div>
                  <div className="text-xs text-orange-500 dark:text-orange-400 mt-1">m²</div>
                </div>
                <div className="bg-orange-200 dark:bg-orange-800 rounded-full p-3">
            ...
            <div className="bg-gradient-to-r from-yellow-50 to-yellow-100 dark:from-yellow-900/20 dark:to-yellow-800/20 rounded-xl p-6 border border-yellow-200 dark:border-yellow-800">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-sm font-medium text-yellow-600 dark:text-yellow-400 mb-2">公顷</div>
                  <div className="text-3xl font-bold text-yellow-700 dark:text-yellow-300">
                    {areaResult && areaResult.ha ? areaResult.ha.toFixed(4) : '0.0000'}
                  </div>
                  <div className="text-xs text-yellow-500 dark:text-yellow-400 mt-1">ha</div>
                </div>
                <div className="bg-yellow-200 dark:bg-yellow-800 rounded-full p-3">
                  <Map className="w-6 h-6 text-yellow-600 dark:text-yellow-300" />
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-xl p-6 border border-green-200 dark:border-green-800">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-sm font-medium text-green-600 dark:text-green-400 mb-2">亩</div>
                  <div className="text-3xl font-bold text-green-700 dark:text-green-300">
                    {areaResult && areaResult.mu ? areaResult.mu.toFixed(4) : '0.0000'}
                  </div>
                  <div className="text-xs text-green-500 dark:text-green-400 mt-1">中国亩</div>
                </div>
          ...
          <button onClick={calculateArea} className="w-full bg-orange-600 text-white py-3 px-4 rounded-lg hover:bg-orange-700 transition-colors flex items-center justify-center font-medium">
